...
```{r}
# Replace values to missing codes: -99 (completely missing), -98 (skipped due to logic), -97 (don't know)
# Ensure all relevant columns are treated as characters before replacement
